---
url: "https://mirascope.com/docs/mirascope/getting-started/migration"
title: "Migration Guide: v0 → v1 | Mirascope"
---

# Mirascope 0.x Migration Guide [Link to this heading](https://mirascope.com/docs/mirascope/getting-started/migration\#mirascope-0-x-migration-guide)

This Guide May Not Cover Everything
...
## Understanding the Shift from v0 to v1 [Link to this heading](https://mirascope.com/docs/mirascope/getting-started/migration\#understanding-the-shift-from-v0-to-v1)

### Why Decorators Instead of Classes? [Link to this heading](https://mirascope.com/docs/mirascope/getting-started/migration\#why-decorators-instead-of-classes)
...
### Benefits of the New Approach [Link to this heading](https://mirascope.com/docs/mirascope/getting-started/migration\#benefits-of-the-new-approach)
...
## Core Changes [Link to this heading](https://mirascope.com/docs/mirascope/getting-started/migration\#core-changes)
...
### From Classes to Decorators [Link to this heading](https://mirascope.com/docs/mirascope/getting-started/migration\#from-classes-to-decorators)
...
#### `BasePrompt` [Link to this heading](https://mirascope.com/docs/mirascope/getting-started/migration\#baseprompt)
...
#### Statefulness [Link to this heading](https://mirascope.com/docs/mirascope/getting-started/migration\#statefulness)
...
### Async Calls [Link to this heading](https://mirascope.com/docs/mirascope/getting-started/migration\#async-calls)
...
### Streaming [Link to this heading](https://mirascope.com/docs/mirascope/getting-started/migration\#streaming)
...
### Tools (Function Calling) [Link to this heading](https://mirascope.com/docs/mirascope/getting-started/migration\#tools-function-calling)
...
### Streaming Tools [Link to this heading](https://mirascope.com/docs/mirascope/getting-started/migration\#streaming-tools)
...
### Extracting Structured Information [Link to this heading](https://mirascope.com/docs/mirascope/getting-started/migration\#extracting-structured-information)
...
### JSON Mode [Link to this heading](https://mirascope.com/docs/mirascope/getting-started/migration\#json-mode)
...
### Streaming Structured Information [Link to this heading](https://mirascope.com/docs/mirascope/getting-started/migration\#streaming-structured-information)
...
### Dynamic Variables and Chaining [Link to this heading](https://mirascope.com/docs/mirascope/getting-started/migration\#dynamic-variables-and-chaining)
...
### Dumping Call Information [Link to this heading](https://mirascope.com/docs/mirascope/getting-started/migration\#dumping-call-information)
...
### Multimodal Capabilities [Link to this heading](https://mirascope.com/docs/mirascope/getting-started/migration\#multimodal-capabilities)
...
### FastAPI Integration [Link to this heading](https://mirascope.com/docs/mirascope/getting-started/migration\#fastapi-integration)
