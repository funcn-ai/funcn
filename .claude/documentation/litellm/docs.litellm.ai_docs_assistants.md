...
[Skip to main content](https://docs.litellm.ai/docs/assistants#__docusaurus_skipToContent_fallback)
...
## **Supported Providers**: [​](https://docs.litellm.ai/docs/assistants\#supported-providers "Direct link to supported-providers")

- [OpenAI](https://docs.litellm.ai/docs/assistants#quick-start)
- [Azure OpenAI](https://docs.litellm.ai/docs/assistants#azure-openai)
- [OpenAI-Compatible APIs](https://docs.litellm.ai/docs/assistants#openai-compatible-apis)

## Quick Start [​](https://docs.litellm.ai/docs/assistants\#quick-start "Direct link to Quick Start")
...
### SDK + PROXY [​](https://docs.litellm.ai/docs/assistants\#sdk--proxy "Direct link to SDK + PROXY")
...
## Streaming [​](https://docs.litellm.ai/docs/assistants\#streaming "Direct link to Streaming")
...
## [👉 Proxy API Reference](https://litellm-api.up.railway.app/\#/assistants) [​](https://docs.litellm.ai/docs/assistants\#-proxy-api-reference "Direct link to -proxy-api-reference")

## Azure OpenAI [​](https://docs.litellm.ai/docs/assistants\#azure-openai "Direct link to Azure OpenAI")
...
## OpenAI-Compatible APIs [​](https://docs.litellm.ai/docs/assistants\#openai-compatible-apis "Direct link to OpenAI-Compatible APIs")
...
- [**Supported Providers**:](https://docs.litellm.ai/docs/assistants#supported-providers)
- [Quick Start](https://docs.litellm.ai/docs/assistants#quick-start)
  - [SDK + PROXY](https://docs.litellm.ai/docs/assistants#sdk--proxy)
- [Streaming](https://docs.litellm.ai/docs/assistants#streaming)
- [👉 Proxy API Reference](https://docs.litellm.ai/docs/assistants#-proxy-api-reference)
- [Azure OpenAI](https://docs.litellm.ai/docs/assistants#azure-openai)
- [OpenAI-Compatible APIs](https://docs.litellm.ai/docs/assistants#openai-compatible-apis)