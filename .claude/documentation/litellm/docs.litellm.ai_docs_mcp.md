...
#### Usage [​](https://docs.litellm.ai/docs/mcp\#usage "Direct link to Usage")
...
#### 3\. Make an LLM API request [​](https://docs.litellm.ai/docs/mcp\#3-make-an-llm-api-request "Direct link to 3. Make an LLM API request")
