"""Templates for generating sygaldry.md documentation files."""
...
TEMPLATE_SYGALDRY_MD = """# {component_name}
...
- List any sygaldry registry components this depends on
...
**Related Components:**
- List related sygaldry components
...
def generate_sygaldry_md(component_json: dict, existing_readme: str = None) -> str:
    """Generate sygaldry.md content from component.json data using type-specific templates."""
    ...
    if authors_list:
        ...
        authors = "Sygaldry Project <info@sygaldry.ai>"
...
- [Sygaldry Registry]({repository_url})"""
...
def generate_template_sygaldry_md(component_name: str) -> str:
    """Generate a template sygaldry.md for new components."""
    return TEMPLATE_SYGALDRY_MD.format(component_name=component_name)


def merge_with_existing_sygaldry_md(existing_content: str, new_content: str, component_data: dict) -> str:
    """
    Merge existing sygaldry.md content with newly generated content.
    ...
    Args:
        existing_content: The current sygaldry.md content
        new_content: The newly generated sygaldry.md content
