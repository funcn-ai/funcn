...
CURSOR_RULES_TEMPLATE = """# Sygaldry Development Rules
...
WINDSURF_RULES_TEMPLATE = """# Sygaldry AI Development Guidelines
...
CLINE_RULES_TEMPLATE = """# Sygaldry Development Guidelines

## Overview
You're working with a Sygaldry AI project that uses Mirascope for LLM integrations.

## Core Technologies
- **Python 3.12+**: Primary language
- **Mirascope**: LLM calls and prompt templates
- **Pydantic**: Data validation and response models
- **Sygaldry Registry**: Component management system
...
### Component Development
- Follow the sygaldry component structure
...
CLAUDE_RULES_TEMPLATE = """# Sygaldry Development Context
...
SOURCEGRAPH_RULES_TEMPLATE = """# Sygaldry Codebase Memory
...
OPENAI_CODEX_RULES_TEMPLATE = """# Sygaldry Development Guidelines
...
AMP_CODE_RULES_TEMPLATE = """# Sygaldry Development Guide
...
def generate_editor_rules(editor: str, components: list[dict]) -> str:
    ...
    component_structure = "Standard sygaldry component with component.json manifest"
