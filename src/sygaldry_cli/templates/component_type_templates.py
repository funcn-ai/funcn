"""Component type-specific templates for generating customized sygaldry.md documentation."""
...
- **Dependency Conflicts**: Run `sygaldry add {component_name}` to reinstall dependencies
