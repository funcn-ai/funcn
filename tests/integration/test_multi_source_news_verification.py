...
from packages.sygaldry_registry.components.agents.multi_source_news_verification.agent import (
    CredibilityLevel,
    MisinformationType,
    VerificationResult,
    VerificationStatus,
...
class TestMultiSourceNewsVerification:
    ...
    async def test_pandemic_misinformation_verification(self):
        ...
        with patch("packages.sygaldry_registry.components.agents.multi_source_news_verification.agent.DUCKDUCKGO_AVAILABLE", True), \
             patch("packages.sygaldry_registry.components.agents.multi_source_news_verification.agent.EXA_AVAILABLE", True):
    ...
    async def test_election_misinformation_with_official_sources(self):
        ...
        with patch("packages.sygaldry_registry.components.agents.multi_source_news_verification.agent.assess_source_credibility") as mock_assess, \
             patch("packages.sygaldry_registry.components.agents.multi_source_news_verification.agent.analyze_news_content") as mock_analyze, \
             patch("packages.sygaldry_registry.components.agents.multi_source_news_verification.agent.fact_check_claims") as mock_fact_check, \
             patch("packages.sygaldry_registry.components.agents.multi_source_news_verification.agent.synthesize_news_verification") as mock_synthesize:
    ...
    async def test_expert_source_verification_pipeline(self):
        ...
        with patch("packages.sygaldry_registry.components.agents.multi_source_news_verification.agent.analyze_news_content") as mock_analyze, \
             patch("packages.sygaldry_registry.components.agents.multi_source_news_verification.agent.fact_check_claims") as mock_fact_check:
