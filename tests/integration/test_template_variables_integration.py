...
from funcn_cli.core.models import Author, ComponentManifest, FileMapping, TemplateVariable
...
""")
        ...
        # Test with Lilypad disabled using FUNCN placeholders
        test_file.write_text("""
...
""")
        ...
        assert "# FUNCN_LILYPAD_IMPORT_PLACEHOLDER" not in content
        assert "# FUNCN_LILYPAD_DECORATOR_PLACEHOLDER" not in content
