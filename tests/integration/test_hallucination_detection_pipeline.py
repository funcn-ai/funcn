...
from packages.funcn_registry.components.agents.hallucination_detector.agent import (
    ClaimVerification,
...
class TestHallucinationDetectionPipeline:
    ...
    async def test_scientific_claim_verification_pipeline(self):
        ...
        with patch("packages.funcn_registry.components.agents.hallucination_detector.agent.exa_search") as mock_search, \
             patch("packages.funcn_registry.components.agents.hallucination_detector.agent.exa_answer") as mock_answer:
    ...
    async def test_realtime_fact_checking_with_retries(self):
        ...
        with patch("packages.funcn_registry.components.agents.hallucination_detector.agent.exa_search", side_effect=mock_search_with_failure):
