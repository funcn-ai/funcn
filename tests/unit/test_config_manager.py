...
import json
import pytest
from funcn_cli.config_manager import ConfigManager, FuncnConfig, RegistrySourceConfig
...
class TestConfigManager:
    ...
    def test_add_registry_source_default_priority(self):
        ...
        with TemporaryDirectory() as tmpdir:
            ...
            config = json.loads((project_root / "funcn.json").read_text())
    ...
    def test_config_backward_compatibility(self):
        """Test that FuncnConfig can handle both string and object sources."""
        with TemporaryDirectory() as tmpdir:
            project_root = Path(tmpdir)
            ...
            (project_root / "funcn.json").write_text(json.dumps(config_data))
