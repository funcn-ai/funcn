...
class TestQwantSearchTool(BaseToolTest):
    ...
    component_path = Path("packages/sygaldry_registry/components/tools/qwant_search")
    ...
    async def test_basic_qwant_search(self):
        ...
        with patch("packages.sygaldry_registry.components.tools.qwant_search.tool.httpx.AsyncClient") as mock_client:
