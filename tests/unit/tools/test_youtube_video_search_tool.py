...
from packages.sygaldry_registry.components.tools.youtube_video_search.tool import (
    TranscriptSegment,
    VideoInfo,
    VideoSearchResult,
...
class TestYoutubeVideoSearchTool(BaseToolTest):
    ...
    component_path = Path("packages/sygaldry_registry/components/tools/youtube_video_search")
    ...
    async def test_search_youtube_videos_basic(self):
        ...
        with patch("packages.sygaldry_registry.components.tools.youtube_video_search.tool.httpx.AsyncClient") as mock_client_class:
    ...
    async def test_get_video_transcript_basic(self):
        ...
        with patch("packages.sygaldry_registry.components.tools.youtube_video_search.tool.YouTubeTranscriptApi") as mock_api:
    ...
    async def test_analyze_video_content_comprehensive(self):
        ...
        with patch("packages.sygaldry_registry.components.tools.youtube_video_search.tool.httpx.AsyncClient") as mock_client_class:
            ...
            # Mock transcript
            with patch("packages.sygaldry_registry.components.tools.youtube_video_search.tool.get_video_transcript") as mock_transcript:
