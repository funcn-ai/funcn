...
from packages.funcn_registry.components.tools.code_docs_search.tool import (
...
class TestCodeDocsSearchTool(BaseToolTest):
    ...
    component_path = Path("packages/funcn_registry/components/tools/code_docs_search")
