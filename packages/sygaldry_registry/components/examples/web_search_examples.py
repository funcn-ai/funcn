#!/usr/bin/env python3
"""
Comprehensive examples of the unified web search agent in the sygaldry registry.
...
# Example imports (these would be available after adding components via sygaldry)
try:
    ...
    print("   sygaldry add duckduckgo_search_tools")
    print("   sygaldry add qwant_search_tools")
    print("   sygaldry add web_search_agent")
...
async def main():
    """Run all examples"""
    print("🚀 Sygaldry Unified Web Search Agent Examples")
    print("=" * 70)
    print()
