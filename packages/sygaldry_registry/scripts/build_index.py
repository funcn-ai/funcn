...
# Re-use models from the main sygaldry package
try:
    from sygaldry_cli.core.models import (
        ComponentManifest,
    ...
    print(
        "[build_index] Could not import sygaldry_cli models. Ensure the project root is on PYTHONPATH.",
        file=sys.stderr,
    )
    raise exc
